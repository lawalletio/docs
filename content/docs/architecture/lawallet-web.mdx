---
title: "lawallet-web"
description: "Next.js application serving frontend, REST API, and lightning address resolution."
---
...
- **lncurl**: HTTP POST to [lncurl.lol](https://lncurl.lol) (or self-hosted instance) to provision courtesy NWC wallets
- No shared database or filesystem with other services

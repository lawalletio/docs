---
title: "Month 4: User Dashboard + Courtesy NWC Proxy"
description: "Enhancement phase: user-facing dashboard, NWC proxy service, wallet polish."
---
...
Standalone Node.js service in its own Docker container. Provisions temporary NWC connection strings from external providers. See [Courtesy NWC Proxy](../architecture/nwc-proxy) for full specification.

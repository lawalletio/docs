...
description: Quick start guide for deploying and using LaWallet NWC.
---
...
- Understand the [Onboarding model](./onboarding) for progressive self-custody
- Explore the [Architecture](../architecture) for system design details

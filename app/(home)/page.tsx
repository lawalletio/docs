  ...
  return (
    <main className="flex flex-1 flex-col relative overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 pt-24 pb-20">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-[#F5A623]/[0.06] rounded-full blur-[160px]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div
              ...
              style={
                { "--hover-color": `${s.color}40` } as React.CSSProperties
              }
            >
              <div
